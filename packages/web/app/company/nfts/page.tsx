...
export default function NFTsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <MobileHeader title="My NFT's" showBack showDropdown onBack={() => router.back()} />
      ...
      <div className="px-6 py-6">
        ...
        <div className="space-y-4">
          {nftLevels.map((nft) => (
            <div key={nft.level} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              <div className={`w-16 h-16 ${nft.color} rounded-full flex items-center justify-center`}>
                {nft.achieved ? (
